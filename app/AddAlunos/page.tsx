...
function SubmitButton() {
  ...
  return (
    <button
      disabled={pending}
      type="submit"
      className="bg-[#1B4F98] text-white p-3 rounded-lg font-bold hover:bg-[#153e77] disabled:opacity-50 flex justify-center items-center gap-2 shadow-md"
    >
      {pending ? (
        <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  name="idade" 
                  required
                  className="border border-gray-300 p-2.5 rounded-lg focus:ring-2 focus:ring-[#1B4F98] focus:border-transparent outline-none bg-white text-gray-700 uppercase text-xs"
                />
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-sm font-medium text-gray-700">
